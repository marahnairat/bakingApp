...
import com.example.bakingapp.retrofit.IRecipe;
import com.example.bakingapp.retrofit.RetrofitBuilder;
...
public class MainActivity extends AppCompatActivity implements RecipeAdapter.ListItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RecipeAdapter recipesAdapter = new RecipeAdapter(this);
        ...
        if(networkAvilable()) {
            if (savedInstanceState != null) {
                ...
                final SimpleIdlingResource idlingResource = (SimpleIdlingResource) ((this)).getIdlingResource();
